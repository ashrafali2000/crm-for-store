interface Prop {
  setAssignedLeader: (value: boolean) => void;
}
const AssignedLeader = ({ setAssignedLeader }: Prop) => {
  return (
    <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto h-screen bg-white fixed inset-0 z-50 outline-none focus:outline-none">
      <div className="relative mx-auto w-full h-full">
        ...
        <div className="border-0 relative flex flex-col w-full  outline-none focus:outline-none">
          ...
          <div className="flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-md">
            <h3 className="text-3xl font-semibold">Assigned Leader</h3>
            <button
              ...
              onClick={() => setAssignedLeader(false)}
            >
              x
            </button>
          </div>
          ...
          <form className="md:w-[50%] w-full mx-auto p-5 md:pt-14">
            <h1 className="md:text-3xl text-xl font-medium mb-5">
              Assigned Leader to this project
            </h1>
            <div className="relative mb-10">
              ...
              <input
                type="search"
                id="default-search"
                className="block w-full p-5 pl-10 text-sm outline-none text-gray-900 shadow-md border rounded-md bg-gray-50 focus:border-indigo-600 :bg-gray-700 :border-gray-600 :placeholder-gray-400 :text-white :focus:ring-blue-500 :focus:border-blue-500"
                placeholder="Search to add a leader"
                required
              />
              <button
                type="submit"
                className="text-white absolute right-3 bottom-3 bg-indigo-600  hover:bg-indigo-500  focus:outline-none  font-medium rounded-md text-sm px-4 py-2 :bg-blue-600 :hover:bg-blue-700 :focus:ring-blue-800"
              >
                Search
              </button>
            </div>
