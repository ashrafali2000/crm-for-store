...
function Index() {
  ...
  console.log("🚀 ~ file: leads.tsx:10 ~ lead:", client);
  return (
    <>
      <div className="w-full overflow-x-auto">
        ...
        {showModal && <ClientForm setShowModal={setShowModal} />}
            ...
            <table className="w-full whitespace-nowrap overflow-x-auto">
              <thead>
                <tr className="h-16 w-full text-sm leading-none text-gray-800">
                  <th className="font-bold text-left px-2">Name</th>
                  <th className="font-bold text-left px-2 ">Client ID</th>
                  <th className="font-bold text-left px-2">Country</th>
                  <th className="font-bold text-left px-2">Email</th>
                  <th className="font-bold text-left px-2">Mobile</th>
                  <th className="font-bold text-left px-2">Status</th>
                  <th className="font-bold text-left px-2 ">Action</th>
                </tr>
              </thead>
              <tbody className="w-full">
                {client.map((clients: any, index: number) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="p-3">
                        <p className="font-medium">{clients.clientId}</p>
                      </td>
                      <td className="p-3">
                        <p className="font-medium">{clients.country}</p>
                      </td>
                      <td className="p-3">
                        <p className="font-medium">{clients.email}</p>
                      </td>
                      <td className="p-3">
                        <p className="font-medium">{clients.phone}</p>
                      </td>
                      <td className="p-3">
