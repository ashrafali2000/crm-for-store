    ...
    <>
      <div className="w-full h-full bg-gray-200">
        <div className="flex flex-no-wrap">
          ...
          <div
            // id="Main"
            className="xl:rounded-r transform showNav xl:translate-x-0 ease-in-out transition duration-500 flex justify-start items-start h-screen w-full sm:w-64 bg-gray-900 flex-col"
          >
            ...
            <div className="mt-6 flex flex-col justify-start items-center px-4 w-full border-gray-600 border-b space-y-3 pb-5 ">
              ...
              >
                ...
                <button className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
                  <p className="text-base leading-4  ">Holidays </p>
                </button>
                <button className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2 w-full md:w-52">
                ...
                <button className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
                  <p className="text-base leading-4  ">Department</p>
                </button>
                <button className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
                  <p className="text-base leading-4  ">Designations</p>
                </button>
              </div>
            </div>
            ...
            <div class="mt-6 flex flex-col justify-start items-center  pl-4 w-full border-gray-600 border-b space-y-3 pb-5 ">
              <button className="focus:outline-none focus:text-indigo-400 text-left text-white w-full space-x-1">
                <p className="text-sm leading-5 uppercase">Tasks</p>
              </button>
            </div>
            <div class="mt-6 flex flex-col justify-start items-center  pl-4 w-full border-gray-600 border-b space-y-3 pb-5 ">
              <button className="focus:outline-none focus:text-indigo-400 text-left text-white w-full space-x-1">
