  ...
  return (
    <>
      <div className="w-full overflow-x-auto">
        ...
        {showModal && <InvoiceForm setShowModal={setShowModal} />}
            ...
            <table className="w-full whitespace-nowrap overflow-x-auto">
              <thead>
                <tr className="h-16 w-full text-sm leading-none text-gray-800">
                  ...
                  <th className="font-bold text-left px-2 ">Invoice Number</th>
                  <th className="font-bold text-left px-2">Client</th>
                  <th className="font-bold text-left px-2">Created Date</th>
                  <th className="font-bold text-left px-2">Due Date</th>
              ...
              <tbody className="w-full">
                <tr className=" h-20 text-sm leading-none text-gray-800 bg-white hover:bg-gray-100 border-b border-t border-gray-400">
                  ...
                  <td className="p-2">
                    <p className="font-medium">#INNV</p>
                  </td>
                  <td className="p-2">
                    <p className="font-medium">Global Technology</p>
                  </td>
                  <td className="p-2">
                    <p className="font-medium">1st Sep 2017</p>
                  </td>
                  <td className="p-2">
                    <p className="font-medium">7th Sep 2017</p>
                  </td>
                  <td className="p-2">
                    <p className="font-medium">$2099</p>
                  </td>
                  <td>
